                        ...
                        <div style="float: right;margin-right: 16%;text-align: center;">
                            <div style="float: left;">
                                ...
                                <p
                                    ...
                                    <b style="margin-left: 31px;text-align: left;">UIT:</b> <span
                                        style="margin-left:37px; text-align: center;"><?php echo htmlentities($rowprint->description); ?></span>
                                </p>
                                <p style="margin:0px;padding: 0px;">
                                    Han Thuyen Street, Thu Duc, Ho Chi Minh.
                                </p>
                                <p style="margin:0px;padding: 0px;">
                                    <b>PRIMARY: </b>Han Thuyen Street, Thu Duc, Ho Chi Minh.
                                </p>
                            </div>
                            <div
                        ...
                        <div style="margin-left: 75px;text-align: center;">
                            ...
                            <div style="    float: left;margin-left: 0%;">
                                ...
                                <p
                                    ...
                                    <b style="margin-left: 31px;">UIT:</b> <span
